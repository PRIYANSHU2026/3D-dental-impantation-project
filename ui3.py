...
class DicomRenderer(QWidget):
    ...
    def loadDicomAndRender(self, directory_path):
        ...
        # Display all DICOM slices using Matplotlib
        self.displayDicomSlices()

    def displayDicomSlices(self):
        self.figure.clear()
        self.ax = self.figure.add_subplot(111)

        # Display all DICOM slices horizontally
        for i, filename in enumerate(self.dicom_files):
            ...
            self.ax.set_title('DICOM Slices')
